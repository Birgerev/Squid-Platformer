...
public class @Input : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Player"",
            ""id"": ""d1102287-c5d4-43ad-8a35-3d5ba37154fe"",
            ""actions"": [
                {
                    ""name"": ""Shoot"",
                    ""type"": ""Button"",
                    ""id"": ""dea10d14-b846-4a63-8559-ce163c17602e"",
                ...
                },
                {
                    ""name"": ""Walk"",
                    ""type"": ""Value"",
                    ""id"": ""912b644e-329e-4729-890b-08fd43d81831"",
                ...
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""8e031ce2-786e-4c03-b5ca-f72bae6a907c"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""CursorPosition"",
                    ""type"": ""Value"",
                    ""id"": ""cf94a0c6-4d58-4c1d-9347-096efcc15b38"",
                ...
                },
                {
                    ""name"": ""CursorDelta"",
                    ""type"": ""Value"",
                    ""id"": ""6a737eec-f4e6-4693-95c7-2dc8451ec020"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""603ec92d-4877-49d5-b836-7bd2fa510c5d"",
                ...
                {
                    ""name"": """",
                    ""id"": ""af8ea8c2-f5f4-470d-820c-20e767321a49"",
                ...
                {
                    ""name"": ""1D Axis"",
                    ""id"": ""4374e36a-4b0f-446a-8189-597e46d6ed23"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""401b61f8-df8a-4ce6-9b0b-c0b188da4a0d"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard & Mouse"",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""92a6fcbd-90a2-4a86-9759-349853a62e9a"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard & Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""7afa49d4-7630-4bac-9615-8f36feb88ead"",
                ...
                {
                    ""name"": """",
                    ""id"": ""70158cbd-34c1-4166-bb8f-5421bef42f64"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard & Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""83614c31-2e2d-4ec5-8b5a-0419e29430bb"",
                ...
                {
                    ""name"": """",
                    ""id"": ""4fce0d83-a332-4142-a9fb-b52f921f1838"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard & Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""1edb997a-7030-43a9-b047-330e1f8badbf"",
